  ...
  return (
    <form onSubmit={handleSave} className="space-y-3">
      <p className="text-sm text-gray-600 dark:text-chalk-dim">
        {current
          ? <>You currently appear as <span className="font-semibold text-black dark:text-chalk">{current}</span>.</>
      ...
      {status === 'saved' && <p className="text-green-600 dark:text-green-400 text-sm font-semibold">Nickname updated!</p>}
