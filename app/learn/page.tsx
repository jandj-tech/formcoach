  ...
  return (
    <main className="flex flex-col min-h-screen bg-white">
      ...
      <section className="flex flex-col items-center text-center px-4 pt-14 pb-10">
        ...
        <h1 className="text-3xl sm:text-5xl font-black text-black leading-tight max-w-2xl">
          Learn how it <span className="text-orange-500">works</span>
        </h1>
        <p className="text-gray-600 text-base sm:text-lg mt-4 max-w-lg leading-relaxed">
      ...
      <section className="px-4 pb-12">
        <div className="max-w-3xl mx-auto bg-gray-50 border border-gray-200 rounded-2xl p-6 sm:p-8">
          <p className="text-orange-500 font-black text-sm uppercase tracking-wider mb-2">Step 1</p>
          <h2 className="text-2xl font-black text-black mb-3">Film your shot the right way</h2>
          <ul className="text-zinc-700 text-sm leading-relaxed space-y-2 list-disc pl-5">
      ...
      <section className="pb-4">
        <div className="max-w-3xl mx-auto text-center px-4 mb-2">
          ...
          <h2 className="text-2xl font-black text-black">What our AI scores</h2>
      ...
      <section className="px-4 pb-14">
        <div className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6">
            ...
            <h3 className="text-xl font-black text-black mb-2">Read your report, then re-test</h3>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6">
            <h3 className="text-xl font-black text-black mb-2">Tokens &amp; teams</h3>
            <p className="text-zinc-700 text-sm leading-relaxed">
      ...
      <section className="px-4 pb-16">
        <div className="max-w-3xl mx-auto bg-black rounded-2xl px-6 py-10 text-center">
