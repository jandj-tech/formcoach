...
export default async function BatchCertificatesPage({ params }: Props) {
  ...
  // Same two ways in as the session plan: the organization that bought the
  // class, or the coach of the team it was assigned to — the person actually
  // handing these certificates out.
