...
const FAQS: Array<{ id?: string; q: string; a: string[] }> = [
  ...
  },
  {
    ...
    a: [
      'Your first analysis is free when you create an account. After that, each analysis is $3.49 — or $1.49 for players on an initiated team. Every LearnHoops Training Basketball from the shop includes 5 free analyses, and bulk orders get volume discounts automatically.',
    ],
  },
  {
    id: 'filming',
