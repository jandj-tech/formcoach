...
export default function CartLink() {
  ...
  return (
    ...
    >
      ...
      {hydrated && count > 0 ? (
        <span className="absolute -top-0.5 -right-0.5 inline-flex items-center justify-center min-w-[1.25rem] h-5 px-1 bg-ember-500 text-ink-950 text-[10px] font-bold rounded-full font-numeric">
          {count > 99 ? '99+' : count}
        </span>
      ) : null}
    </Link>
