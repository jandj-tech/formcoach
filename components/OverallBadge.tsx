...
function grade(score: number) {
  if (score >= 9) return { letter: 'A+', label: 'Elite Form', color: 'text-orange-500', ring: 'ring-green-500' }
  if (score >= 8) return { letter: 'A', label: 'Excellent Form', color: 'text-orange-500', ring: 'ring-green-500' }
  if (score >= 7) return { letter: 'B+', label: 'Good Form', color: 'text-orange-500', ring: 'ring-yellow-500' }
  if (score >= 6) return { letter: 'B', label: 'Solid Form', color: 'text-orange-500', ring: 'ring-yellow-500' }
  if (score >= 5) return { letter: 'C', label: 'Average Form', color: 'text-orange-500', ring: 'ring-orange-500' }
  if (score >= 4) return { letter: 'D', label: 'Needs Work', color: 'text-red-500', ring: 'ring-red-500' }
  return { letter: 'F', label: 'Major Issues', color: 'text-red-600', ring: 'ring-red-600' }
}
