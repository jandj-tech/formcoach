...
function grade(score: number) {
  ...
  if (score >= 7) return { letter: 'B+', label: 'Good Form', color: 'text-green-600', ring: 'ring-green-500' }
  if (score > 5) return { letter: 'B', label: 'Above Average', color: 'text-green-500', ring: 'ring-green-500' }
