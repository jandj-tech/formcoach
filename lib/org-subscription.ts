 ...
 * comp coupon.
 *
 * `amount_off` rather than `percent_off`: a quarter of 1299¢ is 324.75¢, so a
 * percentage would leave Stripe's rounding to decide what the first invoice
 * says after the page had already promised a number. A fixed $3.50 off $12.99
 * is exactly $9.49, every time.
 *
