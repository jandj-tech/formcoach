...
const FILES = ['migrate.sql', 'migrate-teams.sql', 'migrate-organizations.sql', 'migrate-coach-invite.sql', 'migrate-multi-team-coach.sql', 'migrate-pending-players.sql', 'migrate-team-tokens.sql', 'migrate-class-packages.sql', 'migrate-self-coach.sql', 'migrate-coach-credits.sql', 'migrate-shipping-link.sql', 'migrate-class-package-team.sql']
